...
export const EnvironmentProvider = ({ children }) => {
    ...
    const signOut = () => {
        const tokenService = imsAuthInfo?.imsTokenService || window.assetsSelectorsAuthService;
    ...
    return (
        <EnvironmentContext.Provider value={{ environment, setEnvironment, imsAuthInfo, setImsAuthInfo, cancelImsAuthChange, applyImsAuthChange, signOut}}>
            {children}
